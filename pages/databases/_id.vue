<template>
  <v-app>
    <main-drawer v-model="drawer">
      <v-list>
        <v-list-tile
          :to="localePath({ name: 'databases-id', params: $route.params })"
        ...
        <v-list-tile :to="localePath({ name: 'databases-id-projects', params: $route.params })" active-class="primary white--text" nuxt>
          <v-list-tile-title>{{ $t('Projects') }}</v-list-tile-title>
        </v-list-tile>
        <v-list-tile :to="localePath({ name: 'databases-id-data', params: $route.params })" active-class="primary white--text" nuxt>
